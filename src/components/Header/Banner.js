                ...
                <Fade left>
                    <div className="order-1 lg:order-1 flex flex-col justify-center h-full space-y-6">
                        ...
                        <div className="flex flex-col space-y-2">
                            ...
                            <h1 className="poppins text-gray-700 font-semibold text-3xl lg:text-3xl leading-relaxed">Premium Quality <br /> <span className="text-5xl">Medicine</span></h1>
                            <p className="text-gray-500 text-light text-sm">Committed to Public Health.<br/> Guaranteed Safety and Effectiveness.</p>
                        </div>
                        {/* button  */}
